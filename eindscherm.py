...
class Input(wx.Panel):
    ...
    def BoxMaken(self):
        ...
        """
        hbox1 = BoxVorm(wx.HORIZONTAL, [center(self.tekst2),
                                        center(self.tekst3),
                                        center(self.tekst5)], [2, 2, 1])
        hbox2 = BoxVorm(wx.HORIZONTAL, [self.Forprim1, self.Revprim1,
                                        self.pcrprod1], [2, 2, 1])
        hbox3 = BoxVorm(wx.HORIZONTAL, [self.Forprim2, self.Revprim2,
                                        self.pcrprod2], [2, 2, 1])
        hbox4 = BoxVorm(wx.HORIZONTAL, [center(self.tekst6),
                                        center(self.tekst7),
                                        center(self.tekst8)], [2, 2, 1])
        vbox1 = BoxVorm(wx.VERTICAL, [center(self.tekst1), hbox1, hbox2,
                                      center(self.tekst4), hbox4, hbox3],
                        [1, 1, 3, 1, 1, 3])
        return vbox1
